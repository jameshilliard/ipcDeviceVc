...
/*******************************************************************************
 *         Name: MD5String
 *  Description: 使用MD5加密算法，对输入数据进行加密 
 * 
 ...
 *  Revision: none
 ******************************************************************************/
void MD5String(char *in, int in_len, unsigned char *out)
{
	MD5_CTX ctx;
...
/*******************************************************************************
 *         Name: MD5toStr 
 *  Description: 将MD5加密后的数据转换成可打印的字符串 
 * 
 *       Mode   Type                Name         Description
 * -----------------------------------------------------------------------------
 *        in:   unsigned char *     src         输入数据，为MD5加密后的结果
 *              int                 len         输入数据长度
 *    in-out:  
 *       out:   char *              out         转换后的数据
 *    return:   void
